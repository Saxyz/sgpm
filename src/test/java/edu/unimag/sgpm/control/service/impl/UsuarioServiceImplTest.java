...
class UsuarioServiceImplTest {
    ...
    void createUsuario_Success() {
        UsuarioDto request = new UsuarioDto(null, 1, "John", "Doe", "john@example.com", "pass123", Set.of(1));
        Usuario usuarioEntity = mock(Usuario.class);
        Parqueadero parqueadero = new Parqueadero();
        Usuario savedUsuario = mock(Usuario.class);
        UsuarioDto expectedDto = new UsuarioDto(1, 1, "John", "Doe", "john@example.com", "pass123", Set.of(1));
    ...
    void findAllUsuarios_ReturnsList() {
        ...
        UsuarioDto dto1 = new UsuarioDto(1, 1, "John", "Doe", "john@example.com", "pass123", Set.of(1));
        UsuarioDto dto2 = new UsuarioDto(2, 2, "Jane", "Doe", "jane@example.com", "pass456", Set.of(2));
    ...
    void updateUsuarioById_Success() {
        UsuarioDto request = new UsuarioDto(1, 1, "John", "Doe", "john@example.com", "pass123", Set.of(1));
        Usuario usuarioEntity = mock(Usuario.class);
        Parqueadero parqueadero = new Parqueadero();
    ...
    void updateUsuarioById_ParqueaderoNull_Success() {
        UsuarioDto request = new UsuarioDto(1, null, "John", "Doe", "john@example.com", "pass123", Set.of(1));
        Usuario usuarioEntity = mock(Usuario.class);
        Parqueadero parqueadero = new Parqueadero();
        Usuario updatedUsuario = mock(Usuario.class);
        UsuarioDto expectedDto = new UsuarioDto(1, 1, "John", "Doe", "john@example.com", "pass123", Set.of(1));
